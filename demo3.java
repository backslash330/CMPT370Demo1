...
// an integer. You may choose to use either C/C++ or Java, but your code must run on a lab 
// computer. Keep in mind you may want to use this code in assignment two. Avoid duplication 
// of values when inserting nodes in the tree. In this respect, if the tree already contains a node 
// with the value being inserted then no change occurs in the tree when attempting to insert the 
// value. Otherwise a new node should be added to the tree as a leaf node that contains the 
// value to insert

//Tried this with an array, too confusing. Use nodes
public class demo3 {
